...
fetch(headerUrl)
  ...
  .then((json) => {
    ...
    const navHtml = [
      "../html/nav-html/1-index.html",
      "../html/nav-html/2-index.html",
      "../html/nav-html/3-index.html",
      "../html/nav-html/4-index.html",
      "../html/nav-html/5-index.html",
      "../html/nav-html/6-index.html",
    ...
    newDiv.addEventListener("click", () => {
      ...
      document.querySelector(".product_page_wrap").classList.toggle("removeContainer");
